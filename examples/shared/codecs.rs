// Bu dosya, test istemcilerinin (özellikle rtp_utils) sunucudaki ana kodek mantığını 
// kopyalamadan PCMU verisi üretebilmesi için gerekli olan paylaşılan kodek fonksiyonlarını içerir.

// linear_to_ulaw ve ULAW_TABLE `src/rtp/codecs.rs`'ten kopyalandı ve testler için paylaşıldı.
const BIAS: i16 = 0x84;
