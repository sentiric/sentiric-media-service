...
use std::time::Duration; // Duration'ı buraya ekliyoruz
...
pub struct AppConfig {
    ...
    pub rtp_port_quarantine_duration: Duration, // Yeni alan: u64 yerine doğrudan Duration
...
impl AppConfig {
    pub fn load_from_env() -> Result<Self> {
        ...
        // Yeni karantina süresini oku
        let quarantine_seconds: u64 = env::var("RTP_SERVICE_PORT_QUARANTINE_SECONDS")
            .unwrap_or_else(|_| "60".to_string()) // Eğer tanımlı değilse varsayılan 60 sn
            .parse()
        ...
        Ok(AppConfig {
            ...
            rtp_port_min,
            rtp_port_max,
            rtp_port_quarantine_duration: Duration::from_secs(quarantine_seconds), // Doğrudan Duration'a çevir
        })
    }
}